...
const menuStatics = [
  Bodies.rectangle(Game.width / 1, Game.height * 0, 5, 5, {
    isStatic: true,
    render: { sprite: { texture: "./assets/img/bg-men.png" } },
  }),
...
// Fungsi untuk menampilkan pop-up iklan
function showAdPopup() {
  const popup = document.getElementById("ad-popup");
  popup.style.display = "block"; // Menampilkan pop-up
}

// Fungsi untuk menutup pop-up iklan
function closeAdPopup() {
  const popup = document.getElementById("ad-popup");
  popup.style.display = "none"; // Menyembunyikan pop-up
}

// Menampilkan iklan pop-up setelah 3 detik (misalnya setelah game selesai)
setTimeout(showAdPopup, 5000); // Tampilkan pop-up setelah 3 detik

// Menutup pop-up ketika tombol tutup diklik
document.getElementById("close-popup").addEventListener("click", closeAdPopup);
